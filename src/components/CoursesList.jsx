...
export default function CoursesList() {
  ...
  const [openYears, setOpenYears] = useState(() => new Set(years));
              ...
              >
                <div className="flex items-start justify-between gap-4 lg:block">
                  <button
                    ...
                    aria-controls={`courses-year-${year}`}
                    onClick={() => toggleYear(year)}
                    className="course-year-toggle flex w-full items-start justify-between gap-3 text-left hover:text-slate-950 lg:w-auto"
                  >
                    <span>
                    ...
                    <FaChevronDown
                      aria-hidden="true"
                      className="course-year-toggle-icon mt-2 flex-shrink-0 text-sm text-slate-400 lg:mt-6"
                    />
                  </button>
                  <a
                ...
                <div
                  ...
                  aria-hidden={!isOpen}
                  className={`course-year-body ${isOpen ? "" : "course-year-body--closed"}`}
                >
                  <div>
